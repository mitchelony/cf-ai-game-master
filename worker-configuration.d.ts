/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cb4e894ff1d4a9397263e9b3027726e1)
// Runtime types generated with workerd@1.20260317.1 2026-03-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "GameMasterAgent";
	}
	interface Env {
		GameMasterAgent: DurableObjectNamespace<import("./src/server").GameMasterAgent>;
	}
}
